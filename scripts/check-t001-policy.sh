#!/bin/bash
# Lightweight policy fixture for T-001. It verifies the required review policy
...
for file in "${required_files[@]}"; do
  ...
  grep -qi "risk-triggered" "$path" || { echo "missing risk-triggered policy: $file" >&2; exit 1; }
done
...
echo "T-001 risk-triggered review policy checks passed."
